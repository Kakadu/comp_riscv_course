...
project = 'Компиляторы'
copyright = u'2023-2024, Косарев Дмитрий'
author = u'Косарев Дмитрий'
...
htmlhelp_basename = 'compiler_riscv_selection'
...
# Bibliography
extensions.insert(0, 'sphinxcontrib.bibtex')
